...
async function loadData(lat,lng){
  ...
  recompensa = ubicacion['recompensa']==null  ? "" : ubicacion['recompensa'];
  ...
  url = server_name+public+'/detalles_entidad/'+ubicacion['entidad_id'];
  // console.log(url)
...
async function getUbicaciones(lat,lng){
  ...
  ruta = server_name+'/api/getUbicaciones/'+lat+'/'+lng
